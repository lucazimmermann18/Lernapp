...
export function StoryChallenge({unit,story,onBack,onComplete,onRegenerate}){
 ...
 return <main className="story-page">
  ...
  <section className="story-card"><div className="story-kicker">GESCHICHTE ZU „{unit.name.toLocaleUpperCase()}“</div><h1>{story.title}</h1><p className="story-help">Ziehe die englischen Wörter in die passenden Lücken. Auf dem Handy kannst du erst ein Wort und dann eine Lücke antippen.</p>
